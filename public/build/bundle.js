...
var app = (function () {
    ...
    function create_else_block_1(ctx) {
    	...
    	button.$on("click", /*loadStats*/ ctx[2]);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			p = element("p");
    			p.textContent = "Si desea ver los datos presione el botón.";
    			t2 = space();
    			a = element("a");
    			a.textContent = "Página Principal";
    			add_location(br, file$2, 84, 8, 3065);
    			set_style(p, "text-align", "center");
    			set_style(p, "background-color", "antiquewhite");
    			add_location(p, file$2, 85, 8, 3081);
    			attr_dev(a, "href", "#/https://sos2021-sep-arc.herokuapp.com/");
    			attr_dev(a, "class", "svelte-1noyhrl");
    			add_location(a, file$2, 88, 8, 3223);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, schizophreniastats*/ 130) {
    ...
    function create_each_block(ctx) {
    	...
    	let t3;
    	let td2;
    	let t4_value = /*stat*/ ctx[4]["schizophrenia_men"] + "";
    	let t4;
    	let t5;
    	let td3;
    	let t6_value = /*stat*/ ctx[4]["schizophrenia_women"] + "";
    	let t6;
    	let t7;
    	let td4;
    	let t8_value = /*stat*/ ctx[4]["schizophrenia_population"] + "";
    	let t8;
    	let t9;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*schizophreniastats*/ 2 && t0_value !== (t0_value = /*stat*/ ctx[4].country + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*schizophreniastats*/ 2 && t2_value !== (t2_value = /*stat*/ ctx[4].year + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*schizophreniastats*/ 2 && t4_value !== (t4_value = /*stat*/ ctx[4]["schizophrenia_men"] + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*schizophreniastats*/ 2 && t6_value !== (t6_value = /*stat*/ ctx[4]["schizophrenia_women"] + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*schizophreniastats*/ 2 && t8_value !== (t8_value = /*stat*/ ctx[4]["schizophrenia_population"] + "")) set_data_dev(t8, t8_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(tr);
    		}
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "Media de Poblacion con esquizofrenia";
    			t9 = space();
    			tbody = element("tbody");
    ...
    function create_fragment$2(ctx) {
    	...
    	button.$on("click", /*deleteStats*/ ctx[3]);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function deleteStats() {
    		...
    		$$invalidate(0, dataCharged = false);

    		await fetch(API_SCHIZOPHRENIA_STATS, { method: "DELETE" }).then(function (res) {
    			if (res.ok) {
    				console.log("Ok.");
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Schizophrenia> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('dataCharged' in $$props) $$invalidate(0, dataCharged = $$props.dataCharged);
    	...
    	return [dataCharged, schizophreniastats, loadStats, deleteStats];
    }
    ...
    /* src\front\schizophrenia_stats_API\App.svelte generated by Svelte v3.42.1 */
    const file$1 = "src\\front\\schizophrenia_stats_API\\App.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	let h1;
    	let t3;
    	let schizophreniastatstable;
    	let current;
    	schizophreniastatstable = new Schizophrenia({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			style = element("style");
    			style.textContent = "body{background:lightorange}";
    			t1 = space();
    			h1 = element("h1");
    			h1.textContent = "API schizophrenia_stats";
    			t3 = space();
    			create_component(schizophreniastatstable.$$.fragment);
    			add_location(style, file$1, 5, 4, 99);
    			attr_dev(h1, "class", "display-4");
    			set_style(h1, "text-align", "center");
    			add_location(h1, file$1, 6, 4, 148);
    			add_location(main, file$1, 4, 0, 87);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h1);
    			append_dev(main, t3);
    			mount_component(schizophreniastatstable, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(schizophreniastatstable.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(schizophreniastatstable.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(schizophreniastatstable);
    		}
    	};
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ SchizophreniaStatsTable: Schizophrenia });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 14, 2, 388);
    			attr_dev(main, "class", "svelte-jdtmk");
    			add_location(main, file, 13, 1, 379);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
