...
var BASE_API_PATH_v2= "/api/v2"; // F04
var app = express();
...
module.exports.register = (app, BASE_API_PATH_v2) => {
    ...
    app.get(BASE_API_PATH_v2 + "/schizophrenia-stats/loadInitialData", (req, res) => {
    ...
    app.get(BASE_API_PATH_v2 + "/schizophrenia-stats", (req,res)=>{
    ...
    db.find(query).skip(offset).limit(limit).exec((error, schizophrenia_stats) => {
     ...
     app.post(BASE_API_PATH_v2 + "/schizophrenia-stats", (req, res) => {
        var data = req.body;
    ...
    app.get(BASE_API_PATH_v2 + "/schizophrenia-stats/:country/:year", (req, res) => {
    ...
    app.delete(BASE_API_PATH_v2 + "/schizophrenia-stats/:country/:year", (req, res) => {
        var country = req.params.country;
        var year = parseInt(req.params.year);
    ...
    app.put(BASE_API_PATH_v2 + "/schizophrenia-stats/:country/:year", (req, res) => {
    ...
    app.post(BASE_API_PATH_v2 + "/schizophrenia-stats/:country/:date", (req, res) => {
    ...
    app.put(BASE_API_PATH_v2 + "/schizophrenia-stats", (req, res) => {
    ...
    app.delete(BASE_API_PATH_v2 + "/schizophrenia-stats", (req, res) => { 
